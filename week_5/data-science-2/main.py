...
def q1():
    athletes_height_samp = get_sample(athletes, "height", n = 3000)
    _, p_value = sct.shapiro(athletes_height_samp)
    if p_value > 0.05:
        return True
    else:
        return False
...
def q2():
    athletes_height_samp = get_sample(athletes, "height", n = 3000)
    _, p_value = sct.jarque_bera(athletes_height_samp)
    if p_value > 0.05:
        return True
    else:
        return False
...
def q3():
    athletes_height_samp = get_sample(athletes, "weight", n = 3000)
    _, p_value = sct.normaltest(athletes_height_samp)
    if p_value > 0.05:
        return True
    else:
        return False
...
def q4():
    athletes_height_samp = np.log(get_sample(athletes, "weight", n = 3000))
...
def q5():
    ...
    _, p_value = sct.ttest_ind(bra, usa, equal_var = False)
    if p_value > 0.05:
        return True
    else:
        return False
